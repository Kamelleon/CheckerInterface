    ...
    def handle_window(self):
        ...
        while True:
            try:
                ...
                if self.event.startswith("Wstecz"):
                    self.clicked_screens.pop()
                    ...
                    self.window_handler[f'-KOLOR-'].update(visible=False)
                    self.window_handler[f'{self.clicked_screens[-1]}'].update(visible=True)
                ...
                if self.event in ['Kostka brukowa','Pustaki','Daszki',"Gazony","Obrzeza","Stopnie","Palisady"]:
                    ...
                    self.clicked_screens.append("-KOLOR-")
    ...
    gui_window.initialize_window([[
            ...
            sg.Column([
                ...
                [sg.Button('Smart', size=BUTTON_SIZE, font=FONT_SIZE),
                 ...
                 sg.Button('Wstecz', size=BUTTON_SIZE, font=FONT_SIZE,button_color=('red', 'white'))]],
            ...
            sg.Column([
                ...
                [sg.Button('Claro', size=BUTTON_SIZE, key="Claro1", font=FONT_SIZE),
                 ...
                 sg.Button('Wstecz', size=BUTTON_SIZE, font=FONT_SIZE,button_color=('red', 'white'))],
                [sg.T("",pad=(900,500))]],
                 #[sg.T(".", font=("Helvetica", 500000)),sg.T(".", font=("Helvetica", 500)),sg.T(".", font=("Helvetica", 500)),sg.T(".", font=("Helvetica", 500)),sg.T(".", font=("Helvetica", 500)),sg.T(".", font=("Helvetica", 500)),sg.T("", font=("Helvetica", 500)),sg.T("", font=("Helvetica", 500)),sg.T("", font=("Helvetica", 500)),sg.T("", font=("Helvetica", 500)),sg.T("", font=("Helvetica", 500)),sg.T("", font=("Helvetica", 500)),sg.T("", font=("Helvetica", 500))]],
        ...
        sg.Column([
            ...
            sg.Column([
                ...
                [sg.Button('Szary', size=BUTTON_SIZE_FOR_COLORS, font=FONT_SIZE_FOR_COLORS),
                 ...
                 sg.Button('Wstecz', size=BUTTON_SIZE_FOR_COLORS, font=FONT_SIZE_FOR_COLORS,button_color=('red', 'white'))]
            ],
